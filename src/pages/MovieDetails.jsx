...
import { FaStar, FaRegClock, FaDownload, FaPlay } from "react-icons/fa";
...
const MovieDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 ml-40 mr-40 mt-10">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8">
            ...
            <div className="flex-1 text-white">
              ...
              <div className="flex flex-wrap gap-3 mt-6">
                <button className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-semibold flex items-center gap-2 transition">
                  <FaPlay className="text-sm" /> Stream in HD
                </button>
                <button className="bg-gray-700 hover:bg-gray-600 text-white px-6 py-2 rounded-lg font-semibold flex items-center gap-2 transition">
